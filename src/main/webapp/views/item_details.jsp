...
<div class="container-fluid w-75 h-75 p-0" id="container-content">


    <div class="row w-100 h-100 m-0 p-0">


        <div class="col-6 d-flex m-0 p-0 align-items-center justify-content-center">
            <svg class="bd-placeholder-img card-img-top image-holder" id="image-holder" width="100%" height="100%"
        ...
        <div class="col-6">
            ...
            <h1 class="modal-title fs-5"
                id="staticBackdropLabel">Angelfish</h1>
