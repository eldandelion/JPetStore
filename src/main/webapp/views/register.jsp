...
<nav class="navbar navbar-expand-xl fixed-top shadow-sm">
  <div class="container-fluid">
    <img src="${pageContext.request.sourceRoot}../../resources/images/jpetstore.png" alt="" width="32" height="32" class="me-2">
...
<div class="container">
  <main>
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="../../resources/images/jpetstore.png" alt="" width="57" height="57">
      <h2>Checkout form</h2>
